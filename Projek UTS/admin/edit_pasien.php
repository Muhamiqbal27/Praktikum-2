            ...
            <div class="form-group row mt-2">
                ...
                <div class="col-8">
                    <div class='form-check form-check-inline'>
                        <input id="gender_laki" name="gender" type="radio" required="required" <?= ($pasien['gender'] == 'L' ? 'checked' :'') ?> class="form-check-input" value="Laki-Laki">
                        <label for="gender_laki" class="form-check-label">Laki-Laki</label>
                    </div>
                    <div class='form-check form-check-inline'>
                        <input id="gender_perempuan" name="gender" type="radio" required="required" <?= ($pasien['gender'] == 'P' ? 'checked' :'') ?> class="form-check-input" value="Perempuan">
